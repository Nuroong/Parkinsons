 ...
 */
public class TouchResultPagerFragment extends Fragment {
    private static String TAG = "TouchResultFragment";

    public static final String ARG_PARAM1 = "res_pos";
    public static final String ARG_PARAM2 = "res_dev";
    ...
    public TouchResultPagerFragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mresult = getArguments().getDouble(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mver == 0) {
            ...
            mNeedle.setImageBitmap(makeNeedle(mresult));
            ...
            mChartView.makeTouchChart(mdata);
            return rootView;
        }
    }
    ...
    public Bitmap makeNeedle(double angle) {
        ...
        if(angle > 355) mMatrix.postRotate(355);
